...
int db_insert_output(db_t *db, int id, const char *filename, time_t timestamp, const char *contents);
...
int rowset_next_output(rowset_t *rows, const char **filename, time_t *timestamp, const char **contents);
